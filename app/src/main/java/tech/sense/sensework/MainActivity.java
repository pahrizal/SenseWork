...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemIcon.setImageDrawable(getResources().getDrawable(R.drawable.briefcase_icon));
